  ...
  return (function () {
  ...
  })()(
    {
      1: [
            ...
            (function () {
              function Database(config) {
                ...
                if (Array.isArray(config)) {
                  throw new IDBError_1.default(IDBError_1.default.compose('Config has to be an Object'));
                }
                ...
                var hasMetadata = config.tables.every(function (table) {
                  return typeof table === 'function';
                });
                var hasPlainConfig = config.tables.every(function (table) {
                  return _typeof(table) === 'object';
                });

                if (!hasMetadata && !hasPlainConfig) {
                  throw new IDBError_1.default(
                    IDBError_1.default.compose('Config.tables has to be an Array of Objects or Annotated Classes'),
                  );
                }
                ...
                if (validated.error) {
                  throw new IDBError_1.default(validated.error.details);
                }

                this.config = validated.value;
                this.tables =
                  (_a = this.config.tables) === null || _a === void 0
                    ? void 0
                      ...
                      case 2:
                        ...
                        if ((oldVersion < database.version && oldVersion) || db.objectStoreNames.contains(table.name)) {
                          ...
                          console.info(
                            '[' +
                              database.name +
                              ']: DB version changed, removing table: ' +
                              table.name +
                              ' for the fresh start',
                          );
                        }
              ...
              Database.createIndexes = function (store, indexes) {
              ...
              Database.insertInitialValues = function (store, table) {
                for (
                  var _i = 0,
                    _a = (table.initData || []).map(function (item) {
                      return __assign(
                        __assign({}, item),
                        table.timestamps && {
                          createdAt: Date.now(),
              ...
              Database.prototype.useModel = function (target) {
                ...
                if (typeof target === 'function') tableName.value = (0, Decorators_1.getClassMetadata)(target).name;
                ...
                if (typeof target === 'string') return new Model_1.default(this.__connection, table);
        ...
        { './Decorators': 2, './IDBError': 3, './Model': 4, './schema': 7 },
      ],
      2: [
        function (require, module, exports) {
          'use strict';
          ...
          exports.Indexed =
            exports.PrimaryKey =
            exports.getClassMetadata =
            exports.getPropertyMetadata =
            exports.Table =
              void 0;

          require('reflect-metadata');

          var PROPERTY_ATTRIBUTE_OPTIONS = Symbol('PROPERTY_ATTRIBUTE_OPTIONS');
          var TABLE_CLASS_OPTIONS = Symbol('TABLE_CLASS_OPTIONS');
          /**
          ...
          var Table = function Table(options) {
            return function (target) {
              ...
              var assignOptions = __assign(__assign({}, defaultOptions), options);
          ...
          function PropertyDecorator(options) {
            ...
            return function (target, propertyName) {
              ...
              var newMetadata = ((_a = {}), (_a[propertyName] = options), _a);
              var existingMetadata = Reflect.getMetadata(
                PROPERTY_ATTRIBUTE_OPTIONS,
                target === null || target === void 0 ? void 0 : target.constructor,
              );

              if (existingMetadata) {
                if (Reflect.has(existingMetadata, propertyName)) {
                  existingMetadata[propertyName] = __assign(
                    __assign({}, existingMetadata[propertyName]),
          ...
          var PrimaryKey = function PrimaryKey(options) {
            if (options === void 0) {
              options = {};
            }
            ...
            var primaryKey = __assign(__assign({}, defaults), options);
          ...
          var Indexed = function Indexed(options) {
            if (options === void 0) {
              options = {};
            }
            ...
            var indexed = __assign(__assign({}, defaults), options);
      ...
      3: [
        function (require, module, exports) {
          ...
          var IDBError =
            /** @class */
            (function (_super) {
              __extends(IDBError, _super);

              function IDBError(_a, options) {
                var errorDetail = _a[0];

                var _this =
                  _super.call(
                    this,
                    (options === null || options === void 0 ? void 0 : options.message) || errorDetail.message,
                  ) || this;

                _this.name = (options === null || options === void 0 ? void 0 : options.type) || 'IDBValidationError';
                return _this;
              }

              IDBError.is = function (error) {
                return error.name === 'IDBValidationError';
              };

              IDBError.compose = function (message) {
                return [
                  {
                    message: message,
                    path: ['unknown'],
        ...
        function (require, module, exports) {
          ...
          var Model =
            ...
            (function () {
                ...
                return __awaiter(this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    return [
                      ...
                      new Promise(function (resolve, reject) {
                        try {
                          var verifiedInsertData_1 = __assign(
                            __assign({}, Database_1.Database.verify(data, [_this.table])),
                            _this.table.timestamps && {
                              createdAt: Date.now(),
                              updatedAt: Date.now(),
                            },
                          );
              ...
              Model.prototype.selectByPk = function (pKey) {
                return __awaiter(this, void 0, void 0, function () {
                  var _this = this;
              ...
              Model.prototype.selectByIndex = function (indexName, value) {
                return __awaiter(this, void 0, void 0, function () {
                  var _this = this;
              ...
              Model.prototype.openCursor = function () {
                return __awaiter(this, void 0, void 0, function () {
                  var _this = this;
              ...
              Model.prototype.select = function (options) {
                return __awaiter(this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [
                      2,
              ...
              Model.prototype.updateByPk = function (pKey, dataToUpdate) {
                var _this = this;
                ...
                return new Promise(function (resolve, reject) {
                  _this.connection.then(function (db) {
                    _this.selectByPk(pKey).then(function (fetchedData) {
                      ...
                      if (_this.table.timestamps) data.createdAt = Date.now();
              ...
              Model.prototype.deleteByPk = function (pKey) {
                var _this = this;
      ...
      7: [
        function (require, module, exports) {
          ...
          exports.ConfigSchema = joi_1.default.object({
            ...
            name: joi_1.default.string().required().label('Database name').example('MyDatabase'),
            tables: joi_1.default
              .array()
              .items(
                joi_1.default.object({
                  name: joi_1.default.string().required().label('Table name').example('MyTable'),
                  primaryKey: joi_1.default
                    .object({
                      name: joi_1.default.string().optional().label('Primary key name').default('id').example('id'),
                      autoIncrement: joi_1.default
                        .boolean()
                        .optional()
                  ...
                  indexes: joi_1.default
                    .object()
                    .pattern(
                      /./,
                      joi_1.default
                        .object({
                          unique: joi_1.default
                            .boolean()
                            .optional()
                            .default(false)
                            .label('Unique')
            ...
            return (
              (e = {
                ...
                7629: (e, t, r) => {
                  ...
                  const s = r(375),
                    ...
                    v = {
                      Base: class {
                        ...
                        describe() {
                          return (
                            s('function' == typeof m.describe, 'Manifest functionality disabled'), m.describe(this)
                          );
                        }
                        allow(...e) {
                        ...
                        alter(e) {
                          ...
                          for (const r in e) {
                            const n = e[r];
                            s('function' == typeof n, 'Alteration adjuster for', r, 'must be a function'),
                        ...
                        external(e, t) {
                          return (
                            'object' == typeof e &&
                              (s(!t, 'Cannot combine options with description'), (t = e.description), (e = e.method)),
                            s('function' == typeof e, 'Method must be a function'),
                            s(void 0 === t || (t && 'string' == typeof t), 'Description must be a non-empty string'),
                        ...
                        presence(e) {
                          return (
                            s(['optional', 'required', 'forbidden'].includes(e), 'Unknown presence mode', e),
                          ...
                          if (!['any', 'link'].includes(r.type)) {
                            ...
                            for (const t of e)
                              s(
                                ...
                                s(
                                  !t.otherwise || 'any' === t.otherwise.type || t.otherwise.type === r.type,
                                  'Cannot combine',
                                  r.type,
                                  'with',
                        ...
                        concat(e) {
                          ...
                          for (const r of e._singleRules.keys())
                            t._singleRules.has(r) &&
                              ((t._rules = t._rules.filter((e) => e.keep || e.name !== r)), t._singleRules.delete(r));
                          for (const r of e._rules)
                            e._definition.rules[r.method].multi || t._singleRules.set(r.name, r), t._rules.push(r);
                        ...
                        tailor(e) {
                          ...
                          if (this.$_terms.alterations)
                            for (const { target: r, adjuster: n } of this.$_terms.alterations)
                              e.includes(r) &&
                                ((t = n(t)),
                                s(l.isSchema(t), 'Alteration adjuster for', r, 'failed to return a schema object'));
                          return (
                        ...
                        $_addRule(e) {
                          ...
                          return (
                            r.multi || (a._ruleRemove(t.name, { clone: !1 }), a._singleRules.set(t.name, t)),
                        ...
                        $_setFlag(e, t, r = {}) {
                          ...
                          return (
                            void 0 !== t ? ((o._flags[e] = t), o.$_mutateRegister(t)) : delete o._flags[e],
                        ...
                        _default(e, t, r = {}) {
                          return (
                            ...
                            s('function' == typeof t || !r.literal, 'Only function value supports literal option'),
                            'function' == typeof t && r.literal && (t = { [l.symbols.literal]: !0, literal: t }),
                            this.$_setFlag(e, t)
                          );
                        }
                        _generate(e, t, r) {
                          ...
                          for (let a = 0; a < this.$_terms.whens.length; ++a) {
                            ...
                            for (let c = 0; c < l.length; ++c) {
                              const { is: u, then: f, otherwise: m } = l[c],
                          ...
                          return (
                            this.$_root._tracer && this.$_root._tracer._combine(o, [this, ...s]),
                            (this.$_temp.whens[a] = o),
                            { schema: o, id: a }
                          );
                        }
                        _inner(e, t, r = {}) {
                        ...
                        _values(e, t) {
                          ...
                          n && r[t].override();
                          for (const n of e) {
                            s(void 0 !== n, 'Cannot call allow/valid/invalid with undefined'),
                              s(n !== l.symbols.override, 'Override must be the first value');
                  ...
                  (v.Base.prototype[l.symbols.any] = { version: l.version, compile: c.compile, root: '$_root' }),
                    ...
                    (o.Cache = class {
                      constructor(e = {}) {
                        a.assertOptions(e, ['max']),
                          s(void 0 === e.max || (e.max && e.max > 0 && isFinite(e.max)), 'Invalid max cache size'),
                ...
                8160: (e, t, r) => {
                  ...
                  (t.version = a.version),
                    ...
                    (t.isSchema = function (e, r = {}) {
                      ...
                      return (
                        !!n &&
                        (s(r.legacy || n.version === t.version, 'Cannot mix different versions of joi schemas'), !0)
                      );
                    }),
                    ...
                    (t.preferences = function (e, s) {
                      ...
                      return (
                        s.errors &&
                          ...
                          (n.errors.wrap = Object.assign({}, e.errors.wrap, s.errors.wrap))),
                        s.messages && (n.messages = o.compile(s.messages, e.messages)),
                  ...
                  (t.schema = function (e, t, r = {}) {
                    ...
                    (o.schema = function (e, t, r) {
                      s(void 0 !== t, 'Invalid undefined schema'),
                        Array.isArray(t) && (s(t.length, 'Invalid empty array schema'), 1 === t.length && (t = t[0]));
                      const a = (t, ...s) => (!1 !== r.override ? t.valid(e.override, ...s) : t.valid(...s));
                      if (o.simple(t)) return a(e, t);
                      if ('function' == typeof t) return e.custom(t);
                      if ((s('object' == typeof t, 'Invalid schema content:', typeof t), n.isResolvable(t)))
                        return a(e, t);
                    ...
                    (t.when = function (e, r, i) {
                      if (
                        (void 0 === i &&
                          (s(r && 'object' == typeof r, 'Missing options'), (i = r), (r = a.create('.'))),
                        Array.isArray(i) && (i = { switch: i }),
                        n.assertOptions(i, ['is', 'not', 'then', 'otherwise', 'switch', 'break']),
                        n.isSchema(r))
                      )
                        return (
                          s(void 0 === i.is, '"is" can not be used with a schema condition'),
                          s(void 0 === i.not, '"not" can not be used with a schema condition'),
                          s(void 0 === i.switch, '"switch" can not be used with a schema condition'),
                          o.condition(e, { is: r, then: i.then, otherwise: i.otherwise, break: i.break })
                        );
                      if (
                        (s(a.isRef(r) || 'string' == typeof r, 'Invalid condition:', r),
                        s(void 0 === i.not || void 0 === i.is, 'Cannot combine "is" with "not"'),
                        void 0 === i.switch)
                      ) {
                        let l = i;
                        void 0 !== i.not && (l = { is: i.not, then: i.otherwise, otherwise: i.then, break: i.break });
                        ...
                        return (
                          ...
                          void 0 === i.is || a.isRef(i.is) || n.isSchema(i.is) || (c = c.required()),
                          o.condition(e, { ref: t.ref(r), is: c, then: l.then, otherwise: l.otherwise, break: l.break })
                        );
                      }
                      s(Array.isArray(i.switch), '"switch" must be an array'),
                        s(void 0 === i.is, 'Cannot combine "switch" with "is"'),
                        s(void 0 === i.not, 'Cannot combine "switch" with "not"'),
                        s(void 0 === i.then, 'Cannot combine "switch" with "then"');
                      const l = { ref: t.ref(r), switch: [], break: i.break };
                      for (let t = 0; t < i.switch.length; ++t) {
                        const r = i.switch[t],
                          o = t === i.switch.length - 1;
                        n.assertOptions(r, o ? ['is', 'then', 'otherwise'] : ['is', 'then']),
                        ...
                        if ((a.isRef(r.is) || n.isSchema(r.is) || (c.is = c.is.required()), o)) {
                          s(
                            void 0 === i.otherwise || void 0 === r.otherwise,
                ...
                6354: (e, t, r) => {
                  ...
                  (t.Report = class {
                    ...
                    (t.path = function (e) {
                      ...
                      for (const r of e)
                        'object' != typeof r &&
                          ('string' == typeof r ? (t && (t += '.'), (t += r)) : (t += '['.concat(r, ']')));
                      return t;
                    }),
                    ...
                    (t.details = function (e, t = {}) {
                      ...
                      return r.length > 1 && (r = [...new Set(r)]), { message: r.join('. '), details: s };
                    }),
                  ...
                  (t.type = function (e, t) {
                    ...
                    if (u.terms)
                      for (const e in u.terms) {
                        const t = u.terms[e];
                        s(void 0 === c.$_terms[e], 'Invalid term override for', u.type, e),
                          (c.$_terms[e] = t.init),
                          (m[e] = t);
                      }
                    (u.terms = m),
                      u.args || (u.args = f.args),
                      (u.prepare = i.prepare(u.prepare, f.prepare)),
                      u.coerce &&
                      ...
                      (u.coerce = i.coerce(u.coerce, f.coerce)),
                      (u.validate = i.validate(u.validate, f.validate));
                    ...
                    if (u.rules)
                      for (const e in u.rules) {
                        ...
                        if (
                          ...
                          s(!h[e], 'Rule conflict in', u.type, e),
                          (h[e] = t),
                          t.alias)
                        ) {
                    ...
                    return (
                      (p.build = i.build(u.manifest && u.manifest.build, f.manifest && f.manifest.build)),
                      (u.manifest = p),
                      (u.rebuild = i.rebuild(u.rebuild, f.rebuild)),
                      c
                    );
                  }),
                  ...
                  (p.methods = {
                    ...
                    defaults(e) {
                      ...
                      for (const r of t._types) {
                        const n = e(t[r]());
                        s(o.isSchema(n), 'modifier must return a valid schema object'),
                          (t[r] = function (...e) {
                    ...
                    extend(...e) {
                      o.verifyFlat(e, 'extend'),
                        (d = d || r(3378)),
                        s(e.length, 'You need to provide at least one extension'),
                    ...
                    (p.assert = function (e, t, r, s) {
                      const a = s[0] instanceof Error || 'string' == typeof s[0] ? s[0] : null,
                        i = a ? s[1] : s[0],
                        c = t.validate(e, o.preferences({ errors: { stack: !0 } }, i || {}));
                      let u = c.error;
                      if (!u) return c.value;
                      ...
                      throw (
                        ...
                        (u.message = a ? ''.concat(a, ' ').concat(f) : f),
                        u)
                      );
                    }),
                    ...
                    for (let r in e) {
                      ...
                      for (r in ((t[o] = t[o] || {}), n)) {
                        ...
                        'root' === r || a.isTemplate(e)
                          ? (t[o][r] = e)
                          : (s('string' == typeof e, 'Invalid message for', r, 'in', o), (t[o][r] = new a(e)));
                      }
                    }
                    return t;
                  }),
                      ...
                      for (let e in r) {
                        ...
                        for (e in ((o[n] = o[n] || {}), t)) {
                          ...
                          'root' === e || a.isTemplate(r)
                            ? (o[n][e] = r)
                            : (s('string' == typeof r, 'Invalid message for', e, 'in', n), (o[n][e] = new a(r)));
                        }
                      }
                      return o;
                    });
                  ...
                  (t.Ids = c.Ids =
                    class {
                      ...
                      concat(e) {
                        ...
                        for (const [t, r] of e._byId.entries())
                          o(!this._byKey.has(t), 'Schema id conflicts with existing key:', t), this._byId.set(t, r);
                        for (const [t, r] of e._byKey.entries())
                          o(!this._byId.has(t), 'Schema key conflicts with existing id:', t), this._byKey.set(t, r);
                      }
                      fork(e, t, r) {
                        const s = this._collect(e);
                        s.push({ schema: r });
                        const n = s.shift();
                        let a = { id: n.id, schema: t(n.schema) };
                        o(i.isSchema(a.schema), 'adjuster function failed to return a joi schema type');
                        for (const e of s) a = { id: e.id, schema: c.fork(e.schema, a.id, a.schema) };
                        return a.schema;
                      }
                      labels(e, t = []) {
                        const r = e[0],
                        ...
                        const n = e.slice(1);
                        return (
                          (t = [...t, s.schema._flags.label || r]), n.length ? s.schema._ids.labels(n, t) : t.join('.')
                        );
                      }
                      reach(e, t = []) {
                        const r = e[0],
                    ...
                    (t.schema = function (e, t) {
                      ...
                      for (const s in e._flags) {
                        if ('_' === s[0]) continue;
                        const n = c.scan(e._flags[s], { source: 'flags', name: s }, t);
                        void 0 !== n && ((r = r || e.clone()), (r._flags[s] = n));
                      }
                      for (let s = 0; s < e._rules.length; ++s) {
                        const n = e._rules[s],
                          a = c.scan(n.args, { source: 'rules', name: n.name }, t);
                        if (void 0 !== a) {
                          r = r || e.clone();
                      ...
                      for (const s in e.$_terms) {
                        if ('_' === s[0]) continue;
                        const n = c.scan(e.$_terms[s], { source: 'terms', name: s }, t);
                    ...
                    (c.scan = function (e, t, r, s, a) {
                      ...
                      if ((!1 !== r.schema && i.isSchema(e)) || (!1 !== r.ref && l.isRef(e))) {
                        const s = r.each(e, n(n({}, t), {}, { path: o, key: a }));
                        if (s === e) return;
                        return s;
                      }
                      for (const s in e) {
                ...
                6133: (e, t, r) => {
                  ...
                  (t.create = function (e, t = {}) {
                    ...
                    if (((r.type = n.type), (e = n.key), 'value' === r.type))
                      if (
                        (n.root &&
                          (o(!s || e[0] !== s, 'Cannot specify relative path with root prefix'),
                          (r.ancestor = 'root'),
                          e || (e = null)),
                        s && s === e)
                      )
                        ...
                        o(!s || !e || e[0] !== s, 'Cannot combine prefix with ancestor option');
                      else {
                    ...
                    (f.Ref = class {
                      ...
                      resolve(e, t, r, s, n = {}) {
                        return (
                          o(!this.in || n.in, 'Invalid in() reference usage'),
                          'global' === this.type
                            ? this._resolve(r.context, t, n)
                            : 'local' === this.type
                            ? this._resolve(s, t, n)
                            : this.ancestor
                            ? 'root' === this.ancestor
                              ? this._resolve(t.ancestors[t.ancestors.length - 1], t, n)
                              : (o(
                                  this.ancestor <= t.ancestors.length,
                                  'Invalid reference exceeds the schema root:',
                                  this.display,
                                ),
                                this._resolve(t.ancestors[this.ancestor - 1], t, n))
                            : this._resolve(e, t, n)
                        );
                      }
                      _resolve(e, t, r) {
                        ...
                        if (
                          ...
                          void 0 === s && (s = l(e, this.path, { iterables: this.iterables, functions: !0 })),
                    ...
                    (f.Ref.prototype[c.symbols.ref] = !0),
                    (t.build = function (e) {
                      return (
                        'value' === (e = Object.assign({}, f.defaults, e)).type &&
                          void 0 === e.ancestor &&
                          (e.ancestor = 1),
                        new f.Ref(e)
                      );
                    ...
                    (f.context = function (e, t, r = {}) {
                      if (((e = e.trim()), r)) {
                        ...
                        if (s !== t && e.startsWith(s)) return { key: e.slice(s.length), type: 'global' };
                        const n = void 0 === r.local ? '#' : r.local;
                        if (n !== t && e.startsWith(n)) return { key: e.slice(n.length), type: 'local' };
                        const a = void 0 === r.root ? '/' : r.root;
                        if (a !== t && e.startsWith(a)) return { key: e.slice(a.length), type: 'value', root: !0 };
                      }
                        ...
                        if (e)
                          if (((s = void 0 === s ? t.toParent : s), Array.isArray(e)))
                            ...
                            for (const t of e._refs.refs)
                              t.ancestor - s >= 0 && this.refs.push({ ancestor: t.ancestor - s, root: t.root });
                          else
                            t.isRef(e) &&
                              'value' === e.type &&
                              e.ancestor - s >= 0 &&
                              ...
                              (u = u || r(3328)),
                              u.isTemplate(e) && this.register(e.refs(), s);
                      }
                      get length() {
                  ...
                  (n.wrap = s.string().min(1).max(2).allow(!1)),
                      ...
                      args: s
                        ...
                        .items(
                          ...
                          s.object({
                            ...
                            message: s.string().when('assert', { is: s.function(), then: s.required() }),
                          }),
                        ),
                      convert: s.boolean(),
                      manifest: s.boolean(),
                    ...
                    (t.extension = s
                      .object({
                        ...
                        base: s.object().schema().when('type', { is: s.object().regex(), then: s.forbidden() }),
                        coerce: [
                        ...
                        flags: s.object().pattern(n.nameRx, s.object({ setter: s.string(), default: s.any() })),
                            ...
                            s.object({
                              ...
                              manifest: s
                                ...
                                .pattern(/.+/, [
                                  ...
                                  s.object({
                                    mapped: s
                                      .object({ from: s.string().required(), to: s.string().required() })
                                      .required(),
                                  }),
                                ]),
                            }),
                ...
                3328: (e, t, r) => {
                  ...
                  (e.exports = h.Template =
                    class {
                      ...
                      _parse() {
                        ...
                        for (const e of t) {
                          ...
                          const i = ':' === o[0];
                          i && (o = o.slice(1));
                          const l = this._ref(h.decode(o), { raw: t, wrapped: i });
                      ...
                      _ref(e, { raw: t, wrapped: r }) {
                        ...
                        try {
                          var a = new c.Parser(e, { reference: n, functions: h.functions, constants: h.constants });
                        } catch (t) {
                          throw (
                        ...
                        if (a.single) {
                          if ('reference' === a.single.type) {
                            const e = s[0];
                            return { ref: e, raw: t, refs: s, wrapped: r || ('local' === e.type && 'label' === e.key) };
                          }
                          return h.stringify(a.single.value);
                        }
                        return { formula: a, raw: t, refs: s };
                      }
                      toString() {
                        return this.source;
                      }
                    }),
                    (h.Template.prototype[u.symbols.template] = !0),
                    (h.Template.prototype.isImmutable = !0),
                    (h.encode = function (e) {
                      return e
                        .replace(/\\(\{+)/g, (e, t) => h.opens.slice(0, t.length))
                    ...
                    (h.stringify = function (e, t, r, s, a, o = {}) {
                      ...
                      let c = !1;
                      if (
                        (m.isRef(e) && e.render && ((c = e.in), (e = e.resolve(t, r, s, a, n({ in: e.in }, o)))),
                        null === e)
                      )
                        return 'null';
                      ...
                      const u = [];
                      for (const i of e) u.push(h.stringify(i, t, r, s, a, n({ arrayItems: !0 }, o)));
                  ...
                  (e.exports = a.extend({
                    ...
                    validate(e, t) {
                      ...
                      if (r._flags.match) {
                        ...
                        if (0 === t.length)
                          return {
                            errors: s('alternatives.any', { details: i.map((e) => l.details(e, { override: !1 })) }),
                          };
                        if ('one' === r._flags.match)
                          return 1 === t.length ? { value: t[0] } : { errors: s('alternatives.one') };
                        if (t.length !== r.$_terms.matches.length)
                          return {
                            errors: s('alternatives.all', { details: i.map((e) => l.details(e, { override: !1 })) }),
                          };
                        const c = (e) =>
                          e.$_terms.matches.some(
                            (e) => 'object' === e.schema.type || ('alternatives' === e.schema.type && c(e.schema)),
                          );
                        return c(r)
                      ...
                      for (let t = 0; t < r.$_terms.matches.length; ++t) {
                        ...
                        if (s.schema) {
                          ...
                          r.restore(), i.push({ schema: s.schema, reports: n.errors });
                          continue;
                        }
                      ...
                      conditional: {
                        method(e, t) {
                          s(!this._flags._endedSwitch, 'Unreachable condition'),
                            ...
                            s(void 0 === t.break, 'Cannot use break option with alternatives conditional');
                          const r = this.clone(),
                            n = i.when(r, e, t),
                            a = n.is ? [n] : n.switch;
                          for (const e of a)
                        ...
                        if (t.matches)
                          for (const r of t.matches) {
                            ...
                            e = t
                              ? e.try(t)
                              : s
                              ? e.conditional(s, { is: n, then: o, not: a, otherwise: i, switch: r.switch })
                              : e.conditional(n, { then: o, otherwise: i });
                          }
                        return e;
                      },
                    },
                    ...
                    (u.errors = function (e, { error: t, state: r }) {
                      ...
                      for (const { reports: a, schema: o } of e) {
                        ...
                        'base' === f ? s.add(c) : n.push({ type: o.type, report: i });
                      }
                      return n.length
                        ? 1 === n.length
                          ? { errors: n[0].report }
                            ...
                            if ('whens' !== r) {
                              ...
                              for (const t of s) {
                                ...
                                e = i
                                  ...
                                  : e.when(s, { then: a, otherwise: o, break: t.break });
                              }
                          else {
                            const t = {};
                ...
                546: (e, t, r) => {
                  ...
                  (e.exports = o.extend({
                    ...
                    rules: {
                        ...
                        validate(e, { schema: t, error: r, state: s, prefs: n, errorsArray: a }) {
                          ...
                          for (let a = 0; a < h; ++a) {
                            ...
                            if (!t._flags.sparse && void 0 === i) {
                              if (
                                (m.push(r('array.sparse', { key: g, path: y, pos: a, value: void 0 }, s.localize(y))),
                                n.abortEarly)
                              )
                                return m;
                              l.shift();
                            ...
                            for (const e of t.$_terms._exclusions)
                              if (e.$_match(i, s.localize(y, b, e), n, { presence: 'ignore' })) {
                                if ((m.push(r('array.excludes', { pos: a, value: i }, s.localize(y))), n.abortEarly))
                                  return m;
                                (d = !0), l.shift();
                                break;
                              }
                            ...
                            if (t.$_terms.ordered.length) {
                              if (l.length) {
                                ...
                                if (u.errors) {
                                  ...
                                  if (!t._flags.sparse && void 0 === u.value) {
                                    if (
                                      (m.push(
                                        r('array.sparse', { key: g, path: y, pos: a, value: void 0 }, s.localize(y)),
                                      ),
                                      n.abortEarly)
                                    )
                                      return m;
                              ...
                              if (!t.$_terms.items.length) {
                                if (
                                  (m.push(r('array.orderedLength', { pos: a, limit: t.$_terms.ordered.length })),
                                  n.abortEarly)
                                )
                                  return m;
                                break;
                            ...
                            if (!d && (t.$_terms._inclusions.length || t.$_terms._requireds.length) && !p) {
                              ...
                              if ((m.push(r('array.includes', { pos: a, value: i }, s.localize(y))), n.abortEarly))
                                return m;
                            }
                          }
                          return (
                            o.length && c.fillMissedErrors(t, m, o, e, s, n),
                            l.length && (c.fillOrderedErrors(t, m, l, e, s, n), m.length || c.fillDefault(l, e, s, n)),
                            m.length ? m : e
                          );
                        },
                        priority: !0,
                      ...
                      length: {
                        ...
                        validate: (e, t, { limit: r }, { name: s, operator: n, args: a }) =>
                          i.compare(e.length, r, n) ? e : t.error('array.' + s, { limit: a.limit, value: e }),
                        args: [{ name: 'limit', ref: !0, assert: i.limit, message: 'must be a positive integer' }],
                      },
                      max: {
                        method(e) {
                      ...
                      single: {
                        method(e) {
                          const t = void 0 === e || !!e;
                          return (
                            s(!t || !this._flags._arrayItems, 'Cannot specify single rule when array has array items'),
                      ...
                      sort: {
                        method(e = {}) {
                          ...
                          return (
                            e.by &&
                              ((t.by = l.ref(e.by, { ancestor: 0 })), s(!t.by.ancestor, 'Cannot sort by ancestor')),
                        ...
                        validate(e, { error: t, state: r, prefs: s, schema: n }, { options: a }) {
                          ...
                          for (let r = 0; r < e.length; ++r)
                            if (e[r] !== o[r])
                              return t('array.sort', { order: a.order, by: a.by ? a.by.key : 'value' });
                          return e;
                        },
                        convert: !0,
                      },
                      sparse: {
                        method(e) {
                          ...
                          return this._flags.sparse === t
                            ? this
                            : (t ? this.clone() : this.$_addRule('items')).$_setFlag('sparse', t, { clone: !1 });
                        },
                      },
                      unique: {
                        method(e, t = {}) {
                          s(
                            ...
                            i.assertOptions(t, ['ignoreUndefined', 'separator']);
                              ...
                              for (; !(a = s.next()).done; )
                                if (m(a.value[0], o)) {
                                  const s = t.localize([...t.path, n], [e, ...t.ancestors]),
                                    o = { pos: n, value: e[n], dupePos: a.value[1], dupeValue: e[a.value[1]] };
                                  return u && (o.path = i), r('array.unique', o, s);
                                }
                              l.set(o, n);
                            } else {
                              if ((!h || void 0 !== o) && void 0 !== l[o]) {
                                const s = { pos: n, value: e[n], dupePos: l[o], dupeValue: e[l[o]] };
                                return (
                                  u && (s.path = i),
                    ...
                    manifest: {
                      build: (e, t) => (
                        t.items && (e = e.items(...t.items)), t.ordered && (e = e.ordered(...t.ordered)), e
                      ),
                    },
                    messages: {
                    ...
                    (c.fillMissedErrors = function (e, t, r, s, n, a) {
                      ...
                      o.length
                        ? i
                          ...
                          : t.push(e.$_createError('array.includesRequiredKnowns', s, { knownMisses: o }, n, a))
                        : t.push(e.$_createError('array.includesRequiredUnknowns', s, { unknownMisses: i }, n, a));
                    }),
                    ...
                    (c.sort = function (e, t, r, s, n) {
                      const a = 'ascending' === r.order ? 1 : -1,
                        ...
                        l = (l, u) => {
                          ...
                          if (null !== f) return f;
                          if (
                            (r.by && ((l = r.by.resolve(l, s, n)), (u = r.by.resolve(u, s, n))),
                            (f = c.compare(l, u, o, i)),
                            null !== f)
                          )
                            return f;
                          ...
                          if ('number' !== m && 'string' !== m)
                            throw e.$_createError('array.sort.unsupported', t, { type: m }, s, n);
                ...
                4937: (e, t, r) => {
                  ...
                  e.exports = n.extend({
                    ...
                    coerce(e, { schema: t }) {
                      if ('boolean' != typeof e) {
                        ...
                        return (
                          'boolean' != typeof e &&
                            (e =
                              (t.$_terms.truthy && t.$_terms.truthy.has(e, null, null, !t._flags.sensitive)) ||
                              ((!t.$_terms.falsy || !t.$_terms.falsy.has(e, null, null, !t._flags.sensitive)) && e)),
                          { value: e }
                        );
                      }
                    },
                    ...
                    cast: {
                      number: { from: i.isBool, to: (e, t) => (e ? 1 : 0) },
                      string: { from: i.isBool, to: (e, t) => (e ? 'true' : 'false') },
                    },
                    manifest: {
                      build: (e, t) => (
                ...
                7500: (e, t, r) => {
                  ...
                  (e.exports = n.extend({
                    ...
                    rules: {
                      compare: {
                        ...
                        validate(e, t, { date: r }, { name: s, operator: n, args: o }) {
                          ...
                          return a.compare(e.getTime(), i, n) ? e : t.error('date.' + s, { limit: o.date, value: e });
                        },
                        args: [
                          {
                            name: 'date',
                      ...
                      timestamp: {
                        method(e = 'javascript') {
                          return (
                            s(['javascript', 'unix'].includes(e), '"type" must be one of "javascript, unix"'),
                            this.format(e)
                          );
                        },
                      },
                    ...
                    cast: {
                      number: { from: i.isDate, to: (e, t) => e.getTime() },
                      string: { from: i.isDate, to: (e, { prefs: t }) => o.date(e, t) },
                    },
                    messages: {
                  ...
                  e.exports = n.extend({
                    ...
                    rules: {
                      ...
                      class: {
                        ...
                        validate: (e, t) =>
                          /^\s*class\s/.test(e.toString()) ? e : t.error('function.class', { value: e }),
                      },
                      minArity: {
                        method(e) {
                          return (
                            s(Number.isSafeInteger(e) && e > 0, 'n must be a strict positive integer'),
                ...
                7824: (e, t, r) => {
                  ...
                  (e.exports = i.extend({
                    ...
                    validate(e, { schema: t, error: r, state: s, prefs: n }) {
                      ...
                      e = h.clone(e, n);
                      const a = [];
                      if (t.$_terms.renames && !h.rename(t, e, s, n, a)) return { value: e, errors: a };
                      ...
                      if (t.$_terms.keys) {
                        ...
                        for (const i of t.$_terms.keys) {
                          ...
                          if (u.errors) {
                            if (n.abortEarly) return { value: e, errors: u.errors };
                            void 0 !== u.value && (e[t] = u.value), a.push(...u.errors);
                          } else
                            'strip' === i.schema._flags.result || (void 0 === u.value && void 0 !== l)
                              ? delete e[t]
                      ...
                      if (t.$_terms.dependencies)
                        for (const r of t.$_terms.dependencies) {
                          if (r.key && void 0 === r.key.resolve(e, s, n, null, { shadow: !1 })) continue;
                    ...
                    rules: {
                      ...
                      assert: {
                        method(e, t, r) {
                          ...
                          const s = this.$_addRule({ name: 'assert', args: { subject: e, schema: t, message: r } });
                        ...
                        validate(e, { error: t, prefs: r, state: s }, { subject: n, schema: a, message: o }) {
                          ...
                          return a.$_match(i, s.localize(l, [e, ...s.ancestors], a), r)
                            ? e
                            : t('object.assert', { subject: n, message: o });
                        },
                          ...
                          if (e)
                            if (Object.keys(e).length) {
                              t.$_terms.keys = t.$_terms.keys
                                ...
                                : new h.Keys();
                              for (const r in e)
                                l.tryWithPath(() => t.$_terms.keys.push({ key: r, schema: this.$_compile(e[r]) }), r);
                      ...
                      rename: {
                        method(e, t, r = {}) {
                          n('string' == typeof e || e instanceof RegExp, 'Rename missing the from argument'),
                            n('string' == typeof t || t instanceof m, 'Invalid rename to argument'),
                          ...
                          return (
                            t instanceof m && a.$_mutateRegister(t),
                            a.$_terms.renames.push({ from: e, to: t, options: s(h.renameDefaults, r) }),
                            a
                          );
                        },
                      },
                      schema: {
                        ...
                        validate: (e, t, { type: r }) =>
                          !l.isSchema(e) || ('any' !== r && e.type !== r) ? t.error('object.schema', { type: r }) : e,
                      },
                      unknown: {
                        method(e) {
                    ...
                    rebuild(e) {
                      if (e.$_terms.keys) {
                        ...
                        for (const r of e.$_terms.keys)
                          l.tryWithPath(() => t.add(r, { after: r.schema.$_rootReferences(), group: r.key }), r.key);
                    ...
                    manifest: {
                      build(e, t) {
                        if ((t.keys && (e = e.keys(t.keys)), t.dependencies))
                          for (const { rel: r, key: s = null, peers: n, options: a } of t.dependencies)
                            e = h.dependency(e, r, s, n, a);
                        if (t.patterns)
                          for (const { regex: r, schema: s, rule: n, fallthrough: a, matches: o } of t.patterns)
                            e = e.pattern(r || s, n, { fallthrough: a, matches: o });
                    ...
                    (h.dependencies = {
                      and(e, t, r, s, n) {
                        ...
                        for (const e of t.peers)
                          void 0 === e.resolve(r, s, n, null, { shadow: !1 }) ? a.push(e.key) : o.push(e.key);
                        if (a.length !== i && o.length !== i)
                          return {
                            code: 'object.and',
                            context: {
                              present: o,
                      ...
                      nand(e, t, r, s, n) {
                        const a = [];
                        for (const e of t.peers) void 0 !== e.resolve(r, s, n, null, { shadow: !1 }) && a.push(e.key);
                      ...
                      or(e, t, r, s, n) {
                        for (const e of t.peers) if (void 0 !== e.resolve(r, s, n, null, { shadow: !1 })) return;
                        return {
                          code: 'object.missing',
                      ...
                      oxor(e, t, r, s, n) {
                        ...
                        const o = { peers: t.paths, peersWithLabels: h.keysToLabels(e, t.paths) };
                        return (
                          (o.present = a),
                      ...
                      with(e, t, r, s, n) {
                        for (const a of t.peers)
                          if (void 0 === a.resolve(r, s, n, null, { shadow: !1 }))
                            return {
                              code: 'object.with',
                              context: {
                                main: t.key.key,
                      ...
                      for (const o of e.$_terms.renames) {
                        ...
                        if (l)
                          for (const e in t) {
                            ...
                            r && i.push({ from: e, to: o.to, match: r });
                          }
                        else
                        ...
                        for (const c of i) {
                          ...
                          if ((u instanceof m && (u = u.render(t, r, s, c.match)), i !== u)) {
                            if (
                              ...
                              a[u] &&
                              (n.push(
                                e.$_createError('object.rename.multiple', t, { from: i, to: u, pattern: l }, r, s),
                              ),
                              s.abortEarly)
                            )
                              return !1;
                            if (
                              ...
                              !a[u] &&
                              (n.push(
                                e.$_createError('object.rename.override', t, { from: i, to: u, pattern: l }, r, s),
                              ),
                              s.abortEarly)
                            )
                              return !1;
                        ...
                        for (const o of r) {
                          ...
                          for (let f = 0; f < e.$_terms.patterns.length; ++f) {
                            ...
                            if (m.regex) {
                              ...
                              if ((n.mainstay.tracer.debug(n, 'rule', 'pattern.'.concat(f), e ? 'pass' : 'error'), !e))
                                continue;
                            } else if (!m.schema.$_match(o, n.nest(m.schema, 'pattern.'.concat(f)), a)) continue;
                            r.delete(o);
                            const h = n.localize(u, l, { schema: m.rule, key: o }),
                        ...
                        if (o)
                          for (let r = 0; r < i.length; ++r) {
                            ...
                            if (m.errors) {
                              ...
                              if (a.abortEarly) return { value: t, errors: i };
                              s.push(i);
                            }
                          }
                      }
                        ...
                        if (!l.default(e._flags.unknown, a.allowUnknown))
                          for (const o of r) {
                            const r = n.localize([...n.path, o], []),
                              i = e.$_createError('object.unknown', t[o], { child: o }, r, a, { flags: !1 });
                            if (a.abortEarly) return { value: t, errors: i };
                            s.push(i);
                          }
                      }
                    ...
                    (h.Dependency = class {
                      ...
                      describe() {
                        ...
                        return (
                          ...
                          '.' !== this.peers[0].separator && (e.options = { separator: this.peers[0].separator }),
                          e
                        );
                      }
                    }),
                    (h.Keys = class extends Array {
                      concat(e) {
                        ...
                        for (const s of e) {
                          const e = s.key,
                            n = r.get(e);
                          void 0 !== n ? (t[n] = { key: e, schema: t[n].schema.concat(s.schema) }) : t.push(s);
                        }
                        return t;
                      }
                    });
                  ...
                  (e.exports = n.extend({
                      ...
                      ref: {
                        method(e) {
                          s(!this.$_terms.link, 'Cannot reinitialize schema'),
                            (e = o.ref(e)),
                            s('value' === e.type || 'local' === e.type, 'Invalid reference type:', e.type),
                            s(
                    ...
                    (l.generate = function (e, t, r, s) {
                      ...
                      const a = e.$_terms.link[0].ref,
                        { perspective: o, path: i } = l.perspective(a, r);
                    ...
                    (l.perspective = function (e, t) {
                      if ('local' === e.type) {
                        for (const { schema: r, key: s } of t.schemas) {
                          if ((r._flags.id || s) === e.path[0]) return { perspective: r, path: e.path.slice(1) };
                          if (r.$_terms.shared)
                            for (const t of r.$_terms.shared)
                              if (t._flags.id === e.path[0]) return { perspective: t, path: e.path.slice(1) };
                        }
                    ...
                    (l.assert = function (e, t, r, n, a, o) {
                      e ||
                        s(
                          !1,
                          '"'
                            .concat(i.label(n._flags, a, o), '" contains link reference "')
                            .concat(r.display, '" ')
                            .concat(t),
                        );
                    });
                ...
                3832: (e, t, r) => {
                  ...
                  (e.exports = n.extend({
                    ...
                    coerce: {
                      ...
                      method(e, { schema: t, error: r }) {
                        ...
                        if ((0 === n.value && (n.value = 0), !t._flags.unsafe))
                          if (e.match(/e/i)) {
                            if (
                              o.normalizeExponent(''.concat(n.value / Math.pow(10, s[1]), 'e').concat(s[1])) !==
                    ...
                    rules: {
                      compare: {
                        method: !1,
                        validate: (e, t, { limit: r }, { name: s, operator: n, args: o }) =>
                          a.compare(e, r, n) ? e : t.error('number.' + s, { limit: o.limit, value: e }),
                      ...
                      multiple: {
                        ...
                        validate: (e, t, { base: r }, s) =>
                          (e * (1 / r)) % 1 == 0 ? e : t.error('number.multiple', { multiple: s.args.base, value: e }),
                        args: [
                          {
                            name: 'base',
                            ref: !0,
                      ...
                      precision: {
                        ...
                        validate(e, t, { limit: r }) {
                          ...
                          return Math.max((s[1] ? s[1].length : 0) - (s[2] ? parseInt(s[2], 10) : 0), 0) <= r
                            ? e
                  ...
                  (e.exports = h.extend({
                    ...
                    coerce: {
                      ...
                      method(e, { schema: t, state: r, prefs: s }) {
                        ...
                        if (
                          (i && i.args.options.byteAligned && e.length % 2 != 0 && (e = '0'.concat(e)),
                          t.$_getRule('isoDate'))
                        ) {
                          const t = p.isoDate(e);
                          t && (e = t);
                        ...
                        if (t._flags.truncate) {
                          ...
                          if (n) {
                            let a = n.args.limit;
                            if (d.isResolvable(a) && ((a = a.resolve(e, r, s)), !d.limit(a)))
                              return {
                                value: e,
                                errors: t.$_createError(
                                  'any.ref',
                                  a,
                                  { ref: n.args.limit, arg: 'limit', reason: 'must be a positive integer' },
                                  r,
                                  s,
                                ),
                              };
                    ...
                    rules: {
                      ...
                      base64: {
                        method(e = {}) {
                          return (
                            ...
                            (e = n({ urlSafe: !1, paddingRequired: !0 }, e)),
                      ...
                      domain: {
                        ...
                        validate: (e, t, r, { address: s }) => (i.isValid(e, s) ? e : t.error('string.domain')),
                      },
                      email: {
                        method(e = {}) {
                          d.assertOptions(e, [
                          ...
                          if (e.version) {
                            ...
                            for (let e = 0; e < r.length; ++e) {
                              ...
                              o(
                                ...
                                o(!s.has(a), 'version at position ' + e + ' must not be a duplicate'),
                                (t += a),
                                s.add(a);
                            }
                          }
                          ...
                          const r =
                            ...
                            s = new RegExp(
                              '^([\\[{\\(]?)[0-9A-F]{8}('
                                ...
                                .concat(t ? '89AB' : '0-9A-F', '][0-9A-F]{3}\\2?[0-9A-F]{12}([\\]}\\)]?)$'),
                              'i',
                            );
                          return this.$_addRule({ name: 'guid', args: { options: e }, regex: s });
                        },
                        validate(e, t, r, { regex: s }) {
                          const n = s.exec(e);
                          return n
                            ? p.guidBrackets[n[1]] !== n[n.length - 1]
                              ? t.error('string.guid')
                              : e
                            : t.error('string.guid');
                        },
                      ...
                      hostname: {
                        ...
                        validate: (e, t) =>
                          i.isValid(e, { minDomainSegments: 1 }) || p.ipRegex.test(e) ? e : t.error('string.hostname'),
                      },
                      insensitive: {
                        method() {
                      ...
                      ip: {
                        method(e = {}) {
                          ...
                          const { cidr: t, versions: r, regex: s } = c.regex(e),
                            n = e.version ? r : void 0;
                          return this.$_addRule({ name: 'ip', args: { options: { cidr: t, version: n } }, regex: s });
                        },
                        validate: (e, t, { options: r }, { regex: s }) =>
                          s.test(e)
                            ? e
                            : r.version
                            ? t.error('string.ipVersion', { value: e, cidr: r.cidr, version: r.version })
                      ...
                      length: {
                        ...
                        validate(e, t, { limit: r, encoding: s }, { name: n, operator: a, args: o }) {
                          const i = !s && e.length;
                          return d.compare(i, r, a)
                            ? e
                            : t.error('string.' + n, { limit: o.limit, value: e, encoding: s });
                        },
                        args: [
                          { name: 'limit', ref: !0, assert: d.limit, message: 'must be a positive integer' },
                          'encoding',
                        ],
                      },
                      lowercase: {
                      ...
                      uri: {
                        method(e = {}) {
                          ...
                          return this.$_addRule({ name: 'uri', args: { options: e }, regex: t, domain: s, scheme: r });
                        },
                        validate(e, t, { options: r }, { regex: s, domain: n, scheme: a }) {
                          ...
                          if (o) {
                            const s = o[1] || o[2];
                            return !n || (r.allowRelative && !s) || i.isValid(s, n)
                              ? e
                          ...
                          return r.relativeOnly
                            ...
                            : r.scheme
                            ? t.error('string.uriCustomScheme', { scheme: a, value: e })
                            : t.error('string.uri');
                        },
                      },
                    },
                    manifest: {
                      build(e, t) {
                        if (t.replacements)
                          for (const { pattern: r, replacement: s } of t.replacements) e = e.replace(r, s);
                        return e;
                      },
                    },
                    messages: {
                    ...
                    (p.addressOptions = function (e) {
                      ...
                      if (t)
                        return (
                          Array.isArray(t) && (e = Object.assign({}, e, { tlds: { deny: new Set(t) } })),
                      ...
                      return r
                        ? !0 === r
                          ...
                          : (Array.isArray(r) && (e = Object.assign({}, e, { tlds: { allow: new Set(r) } })),
                            o(e.tlds.allow instanceof Set, 'tlds.allow must be an array, Set, or boolean'),
                    ...
                    (p.length = function (e, t, r, s, n) {
                      return (
                        o(!n || !1, 'Invalid encoding:', n),
                        e.$_addRule({ name: t, method: 'length', args: { limit: r, encoding: n }, operator: s })
                      );
                    });
                },
                8826: (e, t, r) => {
                ...
                8863: (e, t, r) => {
                  ...
                  (t.entry = function (e, t, r) {
                    let n = i.defaults;
                    r &&
                      (s(void 0 === r.warnings, 'Cannot override warnings preference in synchronous validation'),
                      s(void 0 === r.artifacts, 'Cannot override artifacts preference in synchronous validation'),
                      (n = i.preferences(i.defaults, r)));
                    ...
                    return (
                      a.error && (o.error = a.error),
                      a.mainstay.warnings.length && (o.warning = l.details(a.mainstay.warnings)),
                      a.mainstay.debug && (o.debug = a.mainstay.debug),
                      a.mainstay.artifacts && (o.artifacts = a.mainstay.artifacts),
                      o
                    );
                  }),
                    (t.entryAsync = async function (e, t, r) {
                      ...
                      if (a.externals.length) {
                        let e = n.value;
                        for (const { method: t, path: n, label: i } of a.externals) {
                          let a,
                            l,
                            c = e;
                          n.length && ((a = n[n.length - 1]), (l = o(e, n.slice(0, -1))), (c = l[a]));
                          try {
                            const s = await t(c, { prefs: r });
                    ...
                    (u.entry = function (e, r, s) {
                      const { tracer: n, cleanup: a } = u.tracer(r, s),
                        ...
                        i = r._ids._schemaChain ? [{ schema: r }] : null,
                        f = new c([], [], { mainstay: o, schemas: i }),
                        m = t.validate(e, r, f, s);
                      a && r.$_root.untrace();
                      const h = l.process(m.errors, e, s);
                      return { value: m.value, error: h, mainstay: o };
                    }),
                    ...
                    (t.validate = function (e, t, r, s, n = {}) {
                      ...
                      c &&
                        c.$_match(u.trim(e, t), r.nest(c), i.defaults) &&
                      ...
                      if (void 0 === e) {
                        ...
                        return u.finalize(e, [t.$_createError('any.unknown', e, null, r, s)], o);
                      const m = [];
                      if (t._valids) {
                        const n = t._valids.get(e, r, s, t._flags.insensitive);
                        if (n)
                          return (
                            s.convert && (r.mainstay.tracer.value(r, 'valids', e, n.value), (e = n.value)),
                      ...
                      for (const o of s._rules) {
                        ...
                        if (o._resolve.length) {
                          ...
                          for (const t of o._resolve) {
                            ...
                            if (m) {
                              c = s.$_createError('any.ref', o, { arg: t, ref: f[t], reason: m }, n, a);
                              break;
                            }
                            f[t] = u;
                          }
                        ...
                        if (m.errors) {
                          ...
                          n.mainstay.tracer.log(s, n, 'rule', o.name, 'pass'),
                            n.mainstay.tracer.value(n, 'rule', e, m.value, o.name),
                            (e = m.value);
                      }
                    ...
                    (u.rule = function (e, t) {
                      return e instanceof l.Report
                        ...
                        : Array.isArray(e) && e[i.symbols.errors]
                    ...
                    (u.finalize = function (e, t, r) {
                      ...
                      if (t.length && n._flags.error)
                        if ('function' == typeof n._flags.error) {
                          ...
                          for (const e of t)
                            s(e instanceof Error || e instanceof l.Report, 'error() must return an Error object');
                      ...
                      if (n.$_terms.externals && o.externals && !1 !== o._externals)
                        for (const { method: e } of n.$_terms.externals)
                          a.mainstay.externals.push({ method: e, path: a.path, label: l.label(n._flags, a, o) });
                      const i = { value: e, errors: t.length ? t : null };
                      return (
                        n._flags.result &&
                          ((i.value = 'strip' === n._flags.result ? void 0 : r.original),
                          a.mainstay.tracer.value(a, n._flags.result, e, i.value),
                          a.shadow(e, n._flags.result)),
                        n._cache && !1 !== o.cache && !n._refs.length && n._cache.set(r.original, i),
                        void 0 === e ||
                          i.errors ||
                    ...
                    (u.prefs = function (e, t) {
                      ...
                      return r && e._preferences[i.symbols.prefs]
                        ? e._preferences[i.symbols.prefs]
                        : ((t = i.preferences(t, e._preferences)), r && (e._preferences[i.symbols.prefs] = t), t);
                    }),
                    (u.default = function (e, t, r, s) {
                      const { schema: a, state: o, prefs: l } = s,
                        c = a._flags[e];
                      ...
                      if ('function' == typeof c) {
                        ...
                        try {
                          ...
                          return void r.push(a.$_createError('any.'.concat(e), null, { error: t }, o, l));
                        }
                      }
                    ...
                    (u.ignore = { active: !1, debug: a, entry: a, filter: a, log: a, resolve: a, value: a }),
                  ...
                  (e.exports = o.Values =
                    class {
                      ...
                      add(e, t) {
                        a.isResolvable(e)
                          ...
                          : this.has(e, null, null, !1) ||
                            (this._values.add(e), 'string' == typeof e && this._lowercase.set(e.toLowerCase(), e));
                      }
                      static merge(e, t, r) {
                      ...
                      remove(e) {
                        a.isResolvable(e)
                          ? this._refs.delete(e)
                          : (this._values.delete(e), 'string' == typeof e && this._lowercase.delete(e.toLowerCase()));
                      }
                      has(e, t, r, s) {
                      ...
                      get(e, t, r, s) {
                        ...
                        if ('object' == typeof e) for (const t of this._values) if (n(t, e)) return { value: t };
                        if (t)
                            ...
                            for (const t of i)
                              if (typeof t == typeof e)
                                if (s && e && 'string' == typeof e) {
                                  if (t.toLowerCase() === e.toLowerCase()) return { value: t, ref: a };
                ...
                978: (e, t, r) => {
                  ...
                  (e.exports = function (e, t, r = {}) {
                    ...
                    return a(o, t, { nullOverride: l, mergeArrays: !1 });
                  }),
                    (i.applyToDefaultsWithShallow = function (e, t, r) {
                      ...
                      return a(f, t, { nullOverride: m, mergeArrays: !1 });
                    }),
                ...
                8571: (e, t, r) => {
                  ...
                  const s = r(9621),
                    n = r(4277),
                    a = r(7043),
                    o = { needsProtoHack: new Set([n.set, n.map, n.weakSet, n.weakMap]) };
                  (e.exports = o.clone =
                    function (e, t = {}, r = null) {
                    ...
                    (o.base = function (e, t, r) {
                      if (!1 === r.prototype)
                        return o.needsProtoHack.has(t) ? new t.constructor() : t === n.array ? [] : {};
                ...
                9474: (e, t, r) => {
                  ...
                  (e.exports = function (e, t, r) {
                    ...
                    (n.isDeepEqualObj = function (e, t, r, a, o) {
                      const { isDeepEqual: i, valueOf: l, hasOwnEnumerableProperty: c } = n,
                  ...
                  (e.exports = function (e, t, r) {
                    ...
                    for (let e = 0; e < o.length; ++e) {
                      ...
                      if (!i || ('function' == typeof i && !1 === r.functions) || (!l && void 0 === i[a])) {
                        s(!r.strict || e + 1 === o.length, 'Missing segment', a, 'in reach path ', t),
                          s(
                            'object' == typeof i || !0 === r.functions || 'function' != typeof i,
                            'Invalid segment',
                            a,
                            'in reach path ',
                            t,
                  ...
                  (t.Sorter = class {
                    ...
                    add(e, t) {
                      const r = [].concat((t = t || {}).before || []),
                        ...
                        a = t.group || '?',
                        o = t.sort || 0;
                      s(!r.includes(a), 'Item cannot come before itself: '.concat(a)),
                        s(!r.includes('?'), 'Item cannot come before unassociated items'),
                        s(!n.includes(a), 'Item cannot come after itself: '.concat(a)),
                        s(!n.includes('?'), 'Item cannot come after unassociated items'),
                        Array.isArray(e) || (e = [e]);
                      for (const t of e) {
                        const e = { seq: this._items.length, sort: o, before: r, after: n, group: a, node: t };
                        this._items.push(e);
                      }
                      if (!t.manual) {
                        const e = this._sort();
                ...
                1745: (e, t, r) => {
                  ...
                  const s = r(9848),
                    n = r(5380),
                    a = r(2178),
                    o = { nonAsciiRx: /[^\x00-\x7f]/, encoder: new (s.TextEncoder || TextEncoder)() };
                  (t.analyze = function (e, t) {
                    return o.email(e, t);
                  }),
                ...
                9959: (e, t, r) => {
                  ...
                  t.regex = function (e = {}) {
                    ...
                    s(
                      ...
                      s(
                        void 0 === e.version || 'string' == typeof e.version || Array.isArray(e.version),
                      ...
                      generate: function () {
                        ...
                        return (
                          (e.hierPart =
                            ...
                            w +
                            "|(?:\\/\\/\\/[\\w-\\.~%\\dA-Fa-f!\\$&'\\(\\)\\*\\+,;=:@]*(?:\\/[\\w-\\.~%\\dA-Fa-f!\\$&'\\(\\)\\*\\+,;=:@]*)*))"),
                          (e.hierPartCapture = '(?:(?:\\/\\/' + y + v + ')|' + _ + '|' + w + ')'),
                          (e.relativeRef = '(?:(?:\\/\\/' + g + v + ')|' + _ + '|' + $ + '|)'),
                          (e.relativeRefCapture = '(?:(?:\\/\\/' + y + v + ')|' + _ + '|' + $ + '|)'),
                          (e.query = '[' + r + '\\/\\?]*(?=#|$)'),
                      ...
                      if (e.scheme) {
                        ...
                        for (let e = 0; e < r.length; ++e) {
                          ...
                          s(
                            ...
                            o instanceof RegExp
                              ? a.push(o.source.toString())
                              : (s(t.schemeRegex.test(o), 'scheme at position ' + e + ' must be a valid scheme'),
                                a.push(n(o)));
                        }
                        i = a.join('|');
                      }
                  ...
                  (t.Parser = class {
                      ...
                      if (!t[r.settings] && t.constants)
                        for (const e in t.constants) {
                          ...
                          if (null !== r && !['boolean', 'number', 'string'].includes(typeof r))
                            throw new Error(
                              'Formula constant '.concat(e, ' contains invalid ').concat(typeof r, ' value type'),
                            );
                        }
                    ...
                    _parse(e) {
                      ...
                      const i = (e) => {
                        ...
                        if (o || n || e) {
                          if (i && 'reference' === i.type && ')' === e)
                            return (i.type = 'function'), (i.value = this._subFormula(n, i.value)), void (n = '');
                          if (')' === e) {
                            ...
                            i && 'operator' === i.type && r.operators.includes(i.value + n)
                              ? (i.value += n)
                      ...
                      i(),
                        (s = s.map((e, t) =>
                          'operator' !== e.type || '-' !== e.value || (t && 'operator' !== s[t - 1].type)
                            ? e
                      ...
                      1 === s.length &&
                        ...
                        (this.single = { type: 'reference' === s[0].type ? 'reference' : 'value', value: s[0].value }),
                        (this._parts = s.map((e) => {
                    ...
                    _subFormula(e, s) {
                      ...
                      if (e) {
                        ...
                        const i = () => {
                          if (!t)
                            throw new Error(
                              'Formula contains function '.concat(s, ' with invalid arguments ').concat(e),
                            );
                          a.push(t), (t = '');
                        };
                        for (let s = 0; s < e.length; ++s) {
