            ...
            function Model() {
              ...
              this.fingersCrossed = new Promise(function (resolve, reject) {
                ...
                request.onerror = function (event) {
                  return reject(
                    request.error || "Make sure you aren't inserting duplicated data for indexed unique values",
                  );
                };
                ...
                request.onupgradeneeded = function (event) {
                  ...
                  if (
                    ...
                    console.info(
                      'DB version changed, therefore table: '.concat(_this.config.tableName, ' has removed'),
                    );
                  }
                ...
                value: function verify(data) {
                  ...
                  if (
                    ((_this$config$primaryK3 = this.config.primaryKey) === null || _this$config$primaryK3 === void 0
                      ? void 0
                      : _this$config$primaryK3.autoIncrement) === false
                  ) {
