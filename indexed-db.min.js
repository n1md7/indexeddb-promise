...
var Database = /** @class */function () {
  function Database(config) {
      ...
      config.tables = config.tables.map(function (target) {
        ...
        propertyEntries.forEach(function (_a) {
          var propertyName = _a[0],
            value = _a[1];
          if (value.primaryKey) composeConfig.primaryKey = {
            name: propertyName,
            autoIncrement: value.primaryKey.autoIncrement,
            unique: value.primaryKey.unique
          };
          if (value.indexed) composeConfig.indexes[propertyName] = {
    ...
    this.tables = (_a = this.config.tables) === null || _a === void 0 ? void 0 : _a.map(function (table) {
      return table.name;
    });
  ...
  Database.insertInitialValues = function (store, table) {
    for (var _i = 0, _a = (table.initData || []).map(function (item) {
        return __assign(__assign({}, item), table.timestamps && {
          createdAt: Date.now(),
          updatedAt: Date.now()
        });
      }); _i < _a.length; _i++) {
...
},{"./Decorators":2,"./IDBError":3,"./Model":4,"./schema":7}],2:[function(require,module,exports){
"use strict";
...
function PropertyDecorator(options) {
  ...
  return function (target, propertyName) {
    ...
    var existingMetadata = Reflect.getMetadata(PROPERTY_ATTRIBUTE_OPTIONS, target === null || target === void 0 ? void 0 : target.constructor);
    if (existingMetadata) {
      if (Reflect.has(existingMetadata, propertyName)) {
        existingMetadata[propertyName] = __assign(__assign({}, existingMetadata[propertyName]), newMetadata[propertyName]);
    ...
    Reflect.defineMetadata(PROPERTY_ATTRIBUTE_OPTIONS, newMetadata, target === null || target === void 0 ? void 0 : target.constructor);
  };
}
/**
...
var getPrimaryKey = function getPrimaryKey(target) {
...
},{"reflect-metadata":47}],3:[function(require,module,exports){
"use strict";
...
var IDBError = /** @class */function (_super) {
  __extends(IDBError, _super);
  function IDBError(_a, options) {
    var errorDetail = _a[0];
    var _this = _super.call(this, (options === null || options === void 0 ? void 0 : options.message) || errorDetail.message) || this;
      ...
      return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
          try {
            ...
            var request_1 = _this.db.transaction(_this.table.name, 'readwrite').objectStore(_this.table.name).add(verifiedInsertData);
            request_1.onsuccess = function () {
              var _a;
              return resolve(_this.resolveValue(__assign(__assign({}, data), primary_1.key && (_a = {}, _a[primary_1.key] = request_1.result, _a))));
            };
            request_1.onerror = function () {
              return reject(request_1.error || 'Unable to add data. Check the unique values');
            };
          } catch (e) {
            return reject(e);
          }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
          ...
          request.onsuccess = function () {
            return resolve(_this.resolveValue(request.result));
          };
        })];
      });
    });
    ...
    if (this.tableClass) {
      if (Array.isArray(value)) {
        return value.map(function (item) {
          return (0, class_transformer_1.plainToInstance)(_this.tableClass, item);
        });
      }
...
},{"./Database":1,"./Decorators":2,"./array-sorter":5,"class-transformer":24}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var ArraySorter = /** @class */function () {
  ...
  ArraySorter.prototype.sortListOfObjects = function (data, key) {
    return data.sort(function (next, current) {
      ...
      // Alphabetical sorting
      if (((_a = current[key]) === null || _a === void 0 ? void 0 : _a.toLowerCase()) > ((_b = next[key]) === null || _b === void 0 ? void 0 : _b.toLowerCase())) return -1;
      if (((_c = current[key]) === null || _c === void 0 ? void 0 : _c.toLowerCase()) < ((_d = next[key]) === null || _d === void 0 ? void 0 : _d.toLowerCase())) return 1;
      return 0;
    });
  };
  return ArraySorter;
...
Object.defineProperty(exports, "Model", {
  enumerable: true,
  get: function get() {
    return __importDefault(Model_1).default;
  }
});
__exportStar(require("./Decorators"), exports);

},{"./Database":1,"./Decorators":2,"./Model":4}],7:[function(require,module,exports){
"use strict";
...
exports.ConfigSchema = joi_1.default.object({
  version: joi_1.default.number().positive().label('Database version').example(1).required().description('The version to open the database with. If the version is not provided and the database exists, then a' + ' connection to the database will be opened without changing its version.'),
  name: joi_1.default.string().required().label('Database name').example('MyDatabase'),
  tables: joi_1.default.array().items(joi_1.default.object({
    ...
    primaryKey: joi_1.default.object({
      ...
      autoIncrement: joi_1.default.boolean().optional().label('Auto increment').default(true).example(true).description('If true, the object store has a key generator.'),
    ...
    indexes: joi_1.default.object().pattern(/./, joi_1.default.object({
      unique: joi_1.default.boolean().optional().default(false).label('Unique').example(true).description('If true, the index will not allow duplicate values for a single key.'),
      multiEntry: joi_1.default.boolean().optional().label('Multi entry').default(true).example(true).description('If true, the index will add an entry in the index for each array element when the keyPath' + ' resolves to an Array. If false, it will add one single entry containing the Array.')
    }).default({
      unique: false,
      multiEntry: true
    ...
    }).label('Indexes').description('It creates a new field/column defining a new data point for each database record to contain.'),
    timestamps: joi_1.default.boolean().optional().label('Timestamps').example(true).default(false).description('If true, createdAt and updatedAt fields will be added automatically.'),
    initData: joi_1.default.array().items(joi_1.default.object()).optional().default([]).label('Initial data').example([{
      name: 'John',
      age: 30
    }]).description('If provided, the database will be initialized with the provided data. The data will be inserted' + ' in the database in the same order as the provided array.')
  })).required().label('Tables')
});

},{"joi":45}],8:[function(require,module,exports){
'use strict'
...
},{"base64-js":8,"buffer":9,"ieee754":44}],10:[function(require,module,exports){
"use strict";
...
},{"./TransformOperationExecutor":12,"./constants/default-options.constant":13,"./enums":22}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./enums":22}],12:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./enums":22,"./storage":40,"./utils":42,"buffer":9}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../storage":40}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../storage":40}],16:[function(require,module,exports){
"use strict";
...
},{"./exclude.decorator":14,"./expose.decorator":15,"./transform-instance-to-instance.decorator":17,"./transform-instance-to-plain.decorator":18,"./transform-plain-to-instance.decorator":19,"./transform.decorator":20,"./type.decorator":21}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../ClassTransformer":10}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../ClassTransformer":10}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../ClassTransformer":10}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../storage":40}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Type = void 0;
const storage_1 = require("../storage");
...
},{"../storage":40}],22:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./transformation-type.enum":23}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ClassTransformer":10,"./decorators":16,"./enums":22,"./interfaces":32}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./class-constructor.type":25,"./class-transformer-options.interface":26,"./decorator-options/exclude-options.interface":27,"./decorator-options/expose-options.interface":28,"./decorator-options/transform-options.interface":29,"./decorator-options/type-discriminator-descriptor.interface":30,"./decorator-options/type-options.interface":31,"./metadata/exclude-metadata.interface":33,"./metadata/expose-metadata.interface":34,"./metadata/transform-fn-params.interface":35,"./metadata/transform-metadata.interface":36,"./metadata/type-metadata.interface":37,"./target-map.interface":38,"./type-help-options.interface":39}],33:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./MetadataStorage":11}],41:[function(require,module,exports){
...
},{"./get-global.util":41,"./is-promise.util":43}],43:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
